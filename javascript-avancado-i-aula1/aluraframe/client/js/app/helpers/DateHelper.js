      ...
      _export("DateHelper", DateHelper = function () {
        ...
        _createClass(DateHelper, null, [{
          ...
          value: function textoParaData(texto) {
            ...
            return new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(texto.split('-').map(function (itemArray, index) {
              return index != 1 ? Number(itemArray) : Number(itemArray) - 1;
            })))))();
          }
        }, {
          key: "dataParaTexto",
